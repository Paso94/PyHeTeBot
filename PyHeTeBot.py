...
pyhetebot = BotHandler(os.environ.get('TOKEN_BOT'))  # create the bot object
    ...
    while True:
        ...
        if last_update != -1:
            try:
                ...
                print url_gtt
                jeson = requests.get(url_gtt).content
                print jeson
                user_file = json.loads(jeson)
                
                pyhetebot.send_message(last_chat_id, jeson)
